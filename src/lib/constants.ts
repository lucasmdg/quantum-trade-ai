...
export const MODULE_COLORS = {
  AI: "#00F0FF", RISK: "#FFAA00", EXECUTION: "#00FF88",
  NEWS: "#AA66FF", PORTFOLIO: "#FF66AA", SYSTEM: "#666666", MARKET: "#4D79FF",
} as const;

export const LEVEL_COLORS = {
  info: "#8B949E", success: "#00FF88", warning: "#FFAA00",
  error: "#FF3355", system: "#666666",
} as const;
